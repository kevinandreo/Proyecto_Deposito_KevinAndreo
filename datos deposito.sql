...
VALUES
		(31, 10, 8, 45, 15, 'total de 1059', 'llamar al 4769-8375', CURRENT_TIME()),
	(31, 9, 14, 10, 7, 'total de 995', 'llamar al 4769-8375', CURRENT_TIME()),
	(31, 31, 22, 56, 4, 'total de 979', 'llamar al 4769-8375', CURRENT_TIME())
;
...
VALUES
		(14, 1, 3, 45, 'Carlos Herrera', 'Cedula de identidad', 'Limpieza semanal', CURRENT_TIME(), 'Mantenimiento mensual')
;
